...
//         {/* Different h2 text for mobile and desktop */}
//         <h2 className="text-center md:text-[40px] md:font-[600] mb-4 font-dmSans text-[#40BBC3]">
//           <span className="block md:hidden">What our customers are saying</span> {/* Mobile text */}
//           <span className="hidden md:block">From The People Who Use Rise</span> {/* Desktop text */}
//         </h2>

//         {/* Different p text for mobile and desktop */}
//         <p className="w-[502px] mb-8 font-dmSans md:font-[500] md:text-[18px] md:leading-[23px] text-[#4A5050]">
...
//       {/* Display one box on mobile and 3 on larger screens */}
...
//           <div
//             key={user.name}
//             className={`w-full md:w-auto p-6 shadow-md rounded-[10px] bg-white mb-6  ${
...
//                 src={user.image}
//                 alt={user.name}
//                 className="w-[32px] h-32 rounded-full mr-4"
//               />
