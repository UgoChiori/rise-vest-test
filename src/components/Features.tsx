...
// const FeatureBlock: React.FC<FeatureProps> = ({ title, description, image, alt, reverse = false }) => {
//   return (
//     <div
//       className={`flex flex-col ${reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center justify-between space-y-6 md:space-y-0 md:space-x-6`}
//     >
//       <div className="space-y-4 md:max-w-[432px] max-w-[326px] text-center md:text-left">
//         <h3 className="text-[18px] md:text-[32px] font-[600] text-[#2D2D2D] leading-[18px] md:leading-[28px] font-dmSans">
//           {title}
...
//           {description}
//         </p>
//         <a href="#" className="text-teal-500 font-semibold inline-block mt-2">
//           Start Investing Now <span className="ml-4">&rarr;</span>
//         </a>
//       </div>
//       <div className="md:flex-shrink-0">
//         <img src={image} alt={alt} className="w-full md:w-auto object-contain" />
//       </div>
//     </div>
//   );
// };
...
//       description:
//         "You can invest towards a goal on Rise—retirement, higher education, saving for your home or travel budgets. Or create agoal of your own and invest periodically to achieve them.",
//       image: "/images/cartoonthree.svg",
//       alt: "Set goals and reach them",
//       reverse: false,
//     },
//     {
