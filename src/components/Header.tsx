...
//   const links = [
//     { name: "Home", url: "#" },
//     { name: "Products", url: "#", subLinks: ["Stocks", "Real Estate", "Fixed Income"] },
...
//         <img src="/images/logo.svg" alt="rise logo" className="w-24 md:w-auto" />
...
const Header: React.FC = () => {
  ...
  // Array to manage navigation links
  const links = [
    { name: "Home", url: "#" },
    { name: "Products", url: "#", subLinks: ["Stocks", "Real Estate", "Fixed Income"] },
    { name: "Investment Club", url: "#" },
  ...
  return (
    <header className="py-6 px-6 font-dmSans">
      <div className="flex justify-between items-center">
        {/* Logo */}
        <img src="/images/logo.svg" alt="rise logo" className="w-24 lg:w-auto" />
